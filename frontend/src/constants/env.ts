...
export const env = {
  ...
  public: publicEnvSchema.parse({
    ...
    RGBPP_EXPLORER_MAINNET_URL: process.env.NEXT_PUBLIC_RGBPP_EXPLORER_MAINNET_URL,
    RGBPP_EXPLORER_TESTNET_URL: process.env.NEXT_PUBLIC_RGBPP_EXPLORER_TESTNET_URL,
